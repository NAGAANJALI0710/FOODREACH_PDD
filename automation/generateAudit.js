...
- **Total Registered Endpoints:** 30 Active Endpoints across 8 domain routers.
...
async function buildEndpointExcel() {
  ...
  endpointList.forEach(e => ws.addRow(e));
...
| **SEC-009** | 🟡 Medium | Insecure Fallback Role Assignment on Missing Profile | CWE-269 | A01:2021-Broken Access Control | Open |
| **SEC-010** | 🟡 Medium | Excessive Payload Limit (10MB) Permitted for JSON Body | CWE-400 | A05:2021-Security Misconfiguration | Open |
| **SEC-011** | 🟡 Medium | Information Disclosure in Verbose Error Responses | CWE-209 | A05:2021-Security Misconfiguration | Open |
| **SEC-012** | 🟡 Medium | Weak Outdated Package Vulnerabilities in Node Dependencies | CWE-1395 | A06:2021-Vulnerable Components | Open |
